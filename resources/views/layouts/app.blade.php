    ...
    <header class="p-5 border-b bg-white shadow">
        ...
        <div class="container mx-auto flex justify-between items-center">
          ...
          @endif --}}
            ...
            {{-- otra forma de ver si esta atuenticado --}}
            @auth
                <nav class="flex gap-2 items-center">
                    ...
                    {{-- forma de evitar ataque de  csrf se valida de esta forma per web.php cambiar de get a post par que funcione el formulario --}}
